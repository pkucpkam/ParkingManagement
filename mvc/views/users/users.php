...
session_start();
    ...
    $usernow = getUserInfo($_SESSION['username']);
?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> <?php echo $usernow['username']; ?></span>
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            ACCOUNT BALANCE</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $usernow['accountBalance']; ?></div>
                                        </div>
                                        <div class="col-auto">
