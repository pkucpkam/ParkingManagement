...
<body id="page-top">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm">
                        ...
                        <!-- Thêm một phần tử để hiển thị thông báo lỗi -->
                        <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            // Xử lý sự kiện khi người dùng nhấn nút Lưu trong modal chỉnh sửa thông tin khách hàng
            $("#updateUser").click(function () {
                // Lấy dữ liệu từ các trường nhập trong modal
                ...
                if (!isValidEmail(email)) {
                    $("#email").addClass("is-invalid"); // Thêm class is-invalid để hiển thị lỗi
                    $("#emailError").text("Email không hợp lệ."); // Hiển thị thông báo lỗi
                    return; // Dừng việc gửi dữ liệu nếu email không hợp lệ
                }

                $.ajax({
                    type: "POST",
                    url: "../../controllers/usersController1.php", // Đường dẫn đến tập tin xử lý PHP
                    data: {
                        editUser: 1,
                        username: username,
                        fullname: fullname,
